# * Name        : test_inversioncounter.cpp
# * Author      : Brandon Cao
# * Version     : 1.0
# * Date        : October 20th, 2019
# * Description : Test cases for number of inversions
...
run_test_args "slow" "5" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
...
run_test_args "slow" "5 7 2 8 3 1" "Enter sequence of integers, each followed by a space: Number of inversions: 10"
run_test_args "slow" "83 34 12 90 102 43 34 29 4 100" "Enter sequence of integers, each followed by a space: Number of inversions: 25"
run_test_args "slow" "81 81 81 81 81 9 9 9 9 9 9" "Enter sequence of integers, each followed by a space: Number of inversions: 30"
run_test_args "slow" "$(echo {99..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 4851"
...
run_test_args "" "5" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
...
run_test_args "" "5 7 2 8 3 1" "Enter sequence of integers, each followed by a space: Number of inversions: 10"
run_test_args "" "83 34 12 90 102 43 34 29 4 100" "Enter sequence of integers, each followed by a space: Number of inversions: 25"
run_test_args "" "81 81 81 81 81 9 9 9 9 9 9" "Enter sequence of integers, each followed by a space: Number of inversions: 30"
run_test_args "" "$(echo {99..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 4851"
